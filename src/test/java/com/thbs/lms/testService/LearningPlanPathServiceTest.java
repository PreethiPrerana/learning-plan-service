...
class LearningPlanPathServiceTest {
    ...
    private Module learningPlanPath, learningPlanPath2;
    ...
    void testSaveLearningPlanPath_Success() {
        when(learningPlanPathRepository.save(any(Module.class))).thenReturn(learningPlanPath);

        Module createdPath = learningPlanPathService.saveLearningPlanPath(learningPlanPath);
    ...
    void testSaveAllLearningPlanPaths_Success() {
        List<Module> learningPlanPaths = new ArrayList<>();
        ...
        List<Module> savedPaths = learningPlanPathService.saveAllLearningPlanPaths(learningPlanPaths);

        assertEquals(2, savedPaths.size());
        verify(learningPlanPathRepository, times(2)).save(any(Module.class));
    }
    ...
    void testSaveAllLearningPlanPaths_EmptyList() {
        ...
        verify(learningPlanPathRepository, never()).save(any(Module.class));
    }
    ...
    void testGetAllLearningPlanPaths_Success() {
        ...
        List<Module> actualPaths = learningPlanPathService.getAllLearningPlanPaths();
    ...
    void testGetAllLearningPlanPathsByLearningPlanId_Success() {
        ...
        List<Module> paths = learningPlanPathService.getAllLearningPlanPathsByLearningPlanId(1L);
    ...
    void testGetAllLearningPlanPathsByType_Success() {
        ...
        List<Module> paths = learningPlanPathService.getAllLearningPlanPathsByType("Test Type");
    ...
    void testGetAllLearningPlanPathsByTrainer_Success() {
        ...
        List<Module> paths = learningPlanPathService.getAllLearningPlanPathsByTrainer("Test Trainer");
    ...
    void testUpdateLearningPlanPathDates_Success() {
        ...
        Optional<Module> updatedPath = learningPlanPathService.updateLearningPlanPathDates(1L, startDate,
                endDate);
    ...
    void testDeleteLearningPlanPaths_Success() {
        List<Module> paths = Arrays.asList(learningPlanPath);
    ...
    void testDeleteLearningPlanPaths_EmptyList() {
        List<Module> paths = new ArrayList<>();
