...
public class LearningPlanPathController {
     ...
     */
    @PostMapping
    public ResponseEntity<Module> createLearningPlanPath(@RequestBody Module learningPlanPath) {
    ...
    public ResponseEntity<List<Module>> createLearningPlanPaths(
            @RequestBody List<Module> learningPlanPaths) {
        List<Module> createdPaths = learningPlanPathService.saveAllLearningPlanPaths(learningPlanPaths);
     ...
     */
    @GetMapping
    public ResponseEntity<List<Module>> getAllLearningPlanPaths() {
        List<Module> paths = learningPlanPathService.getAllLearningPlanPaths();
    ...
    public ResponseEntity<List<Module>> getAllLearningPlanPathsByLearningPlanId(
            @PathVariable Long learningPlanId) {
        List<Module> paths = learningPlanPathService.getAllLearningPlanPathsByLearningPlanId(learningPlanId);
        return ResponseEntity.ok().body(paths);
    }
    ...
    public ResponseEntity<List<Module>> getAllLearningPlanPathsByType(@PathVariable String type) {
        List<Module> paths = learningPlanPathService.getAllLearningPlanPathsByType(type);
        return ResponseEntity.ok().body(paths);
    }
    ...
    public ResponseEntity<List<Module>> getAllLearningPlanPathsByTrainer(@PathVariable String trainerName) {
        List<Module> paths = learningPlanPathService.getAllLearningPlanPathsByTrainer(trainerName);
        return ResponseEntity.ok().body(paths);
    }
